...
namespace Docutaz
{
    ...
    */
    ...
    {
        QString("%1/.3T/robo-3t/1.4.4/robo3t.json").arg(QDir::homePath()), // CONFIG_FILE_1_4_4 (pre-Docutaz path)
    ...
    {
        // Clamp to the known range (0 = System, 1 = Light, 2 = Dark).
        _colorSchemePreference = (scheme >= 0 && scheme <= 2) ? scheme : 0;
    }
